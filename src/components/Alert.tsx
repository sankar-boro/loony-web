...
import { JsonObject } from '../types/index.ts'
import { Alert } from "context/AppContext.tsx";
...
const AlertComponent = ({ alert, onClose }: { alert: Alert, onClose: React.MouseEventHandler<HTMLDivElement>}) => {
