...
import { BookEditAction, BookEditState, BooleanDispatchAction } from "types/index.ts";
...
export default function Edit({ mobileNavOpen, setMobileNavOpen, isMobile }: {
  mobileNavOpen: boolean, setMobileNavOpen: BooleanDispatchAction, isMobile: boolean
}) {
...
const RightBookContainer = ({ book_id, setState, state }: { book_id: string, setState: BookEditAction, state: BookEditState }) => {
  return (
