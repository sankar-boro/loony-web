...
export function Link({ to, state, children }: { to: string, state: RouteState, children: ReactNode }) {
...
export function Route({ path, component }: { path: string, component: React.Component }) {
